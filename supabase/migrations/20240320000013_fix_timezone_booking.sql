...
-- Create base booking function with proper timezone handling
...
BEGIN
  -- Convert timestamps to UTC+1 dates for comparison
  ...
  IF NOT v_is_extension AND v_check_in_date < (CURRENT_DATE AT TIME ZONE 'Europe/Lisbon') + 3 THEN
