...
-- Create manual booking function for admins
...
-- Create trigger to automatically expire holds after 72 hours
...
-- Schedule hold expiry to run every hour
